package dev.kmandalas.issuer.client;
...
public class TrustValidatorClient {
    ...
    public TrustValidatorClient(RestClient.Builder builder, WalletProviderConfig config) {
        this.restClient = builder.baseUrl(config.getTrustValidator().getUrl()).build();
    }
     ...
     * @param context   verification context (e.g., "WalletUnitAttestation")
