package dev.kmandalas.verifier.client;
...
public class TrustValidatorClient {
    ...
    public TrustValidatorClient(RestClient.Builder builder, AppConfig config) {
     ...
     * @param context   verification context (e.g., "PID", "QEAA")
